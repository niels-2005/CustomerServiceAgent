...
from tests.evals.dataset import AgentGoldenCase, load_agent_cases
...
@pytest.mark.parametrize(
    "case",
    AGENT_CASES,
    ids=[case.case_id for case in AGENT_CASES],
)
def test_agent_quality(
    ...
    failures = validate_agent_contract(case, response)
    ...
    publish_metric_outcomes(
        ...
        score_prefix=f"{eval_config.langfuse.score_prefix}.agent",
